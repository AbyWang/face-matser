			        ...
			        <form id="searchForm" class="form form-horizontal" onsubmit="return false;" >
			         <div class="row">
			                <div class="col-xs-12 col-sm-6 col-md-1">
			                       <a type="button" onclick="resetBtn()" class="btn btn-primary btn-rounded  btn-bordered btn-sm"><span class="glyphicon glyphicon-repeat" aria-hidden="true"></span> 识别</a>  
                            </div>
			                <div class="col-xs-12 col-sm-6 col-md-4">
			                     <input type="text" class="form-control input-sm" id="folderName" name="folderName" style="border-radius: 6px;">
			                </div>
			                <div class="col-xs-12 col-sm-6 col-md-4">
			                      <a type="button" onclick="searchBtn()" class="btn btn-primary btn-rounded  btn-bordered btn-sm"><span class="glyphicon glyphicon-search" aria-hidden="true"></span> 选择本地文件</a>
                            </div>
                      </div>
                     <div class="row">
                                 <div class="col-xs-12 col-sm-6 col-md-2">
			                         <div class=" col-md-12"  style="margin-top:20px">
			                            <label  for="name">当前识别结果:</label>
